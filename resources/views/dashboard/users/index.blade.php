    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 ml-64">
            ...
            <div class="p-8">
                @if (session('success'))
                    <div
                        class="mb-4 p-4 text-sm text-green-700 bg-green-50 rounded-xl border border-green-200 flex items-center gap-2">
                ...
                @if (session('error'))
                    <div
                        class="mb-4 p-4 text-sm text-red-700 bg-red-50 rounded-xl border border-red-200 flex items-center gap-2">
                ...
                <div class="flex items-center justify-between mb-6 text-gray-600">
                    <div class="flex items-center gap-3 flex-wrap flex-1">
                        ...
                        <div class="relative inline-block text-left" id="filter-dropdown-container">
                            ...
                            {{-- Dropdown Card --}}
                            <div id="filter-dropdown-card"
                                class="hidden absolute left-0 mt-2 w-80 bg-white border border-gray-200 rounded-xl shadow-lg z-50 p-4 space-y-4">
                                {{-- Radio Angkatan --}}
                                <div>
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Angkatan</label>
                                    <div class="flex flex-wrap gap-x-4 gap-y-2">
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-angkatan" value="all" checked
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                            <span class="ml-2 font-medium text-xs">Semua</span>
                                        </label>
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-angkatan" value="X"
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                            <span class="ml-2 font-medium text-xs">X</span>
                                        </label>
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-angkatan" value="XI"
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                            <span class="ml-2 font-medium text-xs">XI</span>
                                        </label>
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-angkatan" value="XII"
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Jurusan</label>
                                    <div class="flex flex-wrap gap-x-4 gap-y-2">
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-jurusan" value="all" checked
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                            <span class="ml-2 font-medium text-xs">Semua</span>
                                        </label>
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-jurusan" value="RPL"
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                            <span class="ml-2 font-medium text-xs">RPL</span>
                                        </label>
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-jurusan" value="DKV"
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                ...
                                <div class="relative">
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5">Kelas</label>
                                    <input type="text" id="filter-kelas-search" autocomplete="off"
                                        placeholder="Ketik kelas (X-rpl 1, XI-dkv 2)..."
                                    ...
                                    <div id="filter-kelas-suggestions"
                                        class="hidden absolute left-0 right-0 z-50 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg max-h-40 overflow-y-auto divide-y divide-gray-100">
                                    </div>
                                </div>
                                ...
                                <div>
                                    <label
                                        class="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Role</label>
                                    <div class="flex flex-wrap gap-x-4 gap-y-2">
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-role" value="all" checked
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                            <span class="ml-2 font-medium text-xs">Semua</span>
                                        </label>
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-role" value="admin"
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                            <span class="ml-2 font-medium text-xs">Admin</span>
                                        </label>
                                        <label class="inline-flex items-center text-sm text-gray-700 cursor-pointer">
                                            <input type="radio" name="filter-role" value="user"
                                                class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500">
                                ...
                                <div class="flex gap-2 pt-2 border-t border-gray-100">
                                    <button onclick="resetFilters()" type="button"
                                        class="flex-1 px-3 py-1.5 text-xs text-gray-600 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-lg transition-colors font-medium">Reset</button>
                                    <button onclick="applyFilters()" type="button"
                                        class="flex-1 px-3 py-1.5 text-xs text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors font-medium">Terapkan</button>
                                </div>
                            </div>
                        </div>

                        {{-- Reset Filter Button --}}
                        <button onclick="resetAllFilters()" id="reset-filter-btn"
                            class="hidden px-3 py-2 text-sm text-gray-500 hover:text-gray-700 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div class="relative border border-gray-200 rounded-xl shadow-sm overflow-hidden bg-white">
                    <div id="table-loader"
                        class="absolute inset-0 bg-white/75 backdrop-blur-sm flex items-center justify-center transition-all duration-300 opacity-0 pointer-events-none z-10">
                        <div class="flex flex-col items-center gap-2">
                            <i class="fa-solid fa-circle-notch fa-spin text-2xl text-blue-600"></i>
                            <span class="text-xs text-gray-500 font-semibold tracking-wide">Memuat data user...</span>
                        </div>
                    </div>
                    <table class="w-full">
                        <thead class="bg-gray-50 border-b border-gray-200">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">
                                    Nama / Email</th>
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">UID
                                    RFID</th>
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">
                                    Role</th>
                                <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            @forelse ($users as $index => $u)
                                <tr class="hover:bg-gray-50 transition-colors duration-200 user-row"
                                    ...
                                    data-uid="{{ strtolower($u->uid) }}" data-role="{{ $u->role }}"
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="px-2 py-1 text-xs font-semibold rounded-full {{ $u->role === 'admin' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800' }}">
                                            {{ ucfirst($u->role) }}
                                        </span>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex items-center gap-2">
                                        ...
                                        @if (auth()->id() !== $u->id)
                                            <form action="{{ route('users.destroy', $u->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus user ini? Semua data absen terkait juga akan hilang.')" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
